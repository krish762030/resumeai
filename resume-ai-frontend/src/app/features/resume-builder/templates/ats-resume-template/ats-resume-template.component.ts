...
@Component({
  selector: 'app-ats-resume-template',
  templateUrl: './ats-resume-template.component.html',
  styleUrls: ['./ats-resume-template.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AtsResumeTemplateComponent {
