...
@Component({
  ...
  templateUrl: './creative-resume-template.component.html',
  styleUrls: ['./creative-resume-template.component.scss'],
...
export class CreativeResumeTemplateComponent {
  ...
  mainSections(document: ResumeDocument): ResumeDocumentSection[] {
